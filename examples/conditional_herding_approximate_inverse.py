...
for both the features and the response. To reduce computational demand, we approximate
the feature kernel gram matrix's regularised inverse. This coreset is compared to a
coreset generated via uniform random sampling. Coreset quality is measured using
