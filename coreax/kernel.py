...
class Kernel(ABC):
    ...
    def compute(self, x: ArrayLike, y: ArrayLike) -> Array:
        ...
        x = jnp.atleast_2d(x)
        y = jnp.atleast_2d(y)
        return _evaluate_pairwise(self.compute_elementwise)(x, y)
    ...
    def grad_x(self, x: ArrayLike, y: ArrayLike) -> Array:
        ...
        x = jnp.atleast_2d(x)
        y = jnp.atleast_2d(y)
        return _evaluate_pairwise(self.grad_x_elementwise)(x, y)
    ...
    def grad_y(self, x: ArrayLike, y: ArrayLike) -> Array:
        ...
        x = jnp.atleast_2d(x)
        y = jnp.atleast_2d(y)
        return _evaluate_pairwise(self.grad_y_elementwise)(x, y)
    ...
    def divergence_x_grad_y(
        ...
        x = jnp.atleast_2d(x)
        y = jnp.atleast_2d(y)
        return _evaluate_pairwise(self.divergence_x_grad_y_elementwise)(x, y)
    ...
    def calculate_kernel_matrix_row_sum(
        ...
        # points
        kernel_pairwise = jit(self.compute)
