...
from examples.cmmd_basic import main as cmmd_basic_main
...
class TestGreedyCMMDBasic(unittest.TestCase):
    ...
    def test_greedy_cmmd_basic(self) -> None:
        ...
        An end-to-end test to check cmmd_basic.py runs without error, generates
        ...
        with (
            ...
            out_path = Path(tmp_dir) / "cmmd_basic.png"
            cmmd_coreset, cmmd_random = cmmd_basic_main(out_path=out_path)
