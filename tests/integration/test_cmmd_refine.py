...
from examples.cmmd_refine import main as cmmd_refine_main
...
class TestGreedyCMMDRefine(unittest.TestCase):
    """
    ...
    def test_greedy_CMMD_refine(self) -> None:
        ...
        An end-to-end test to check cmmd_refine.py runs without error, generates
        ...
        with (
            ...
            out_path = Path(tmp_dir) / "cmmd_refine.png"
            cmmd_coreset, cmmd_random = cmmd_refine_main(out_path=out_path)
