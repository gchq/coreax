...
A Kernel herding solver can be created by supplying a
:class:`~coreax.kernels.ScalarValuedKernel` object, such as a
:class:`~coreax.kernels.SquaredExponentialKernel`. A coreset is then generated by
calling the :meth:`~coreax.solvers.KernelHerding.reduce` method on the original dataset.
