...
# Sphinx calls this event handler with six positional arguments.
def remove_namedtuple_attrib_docstring(app, what, name, obj, skip, options):  # pylint: disable=too-many-positional-arguments
