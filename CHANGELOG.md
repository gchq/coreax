...
### Changed
 - Solver invariant tests now use the same JIT variant for recomputed solver results as
   the original result under test. (https://github.com/gchq/coreax/issues/1067)
