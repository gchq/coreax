...
### Added
 ...
 - Added performance benchmarks for Caratheodory and tree recombination across polynomial test-function counts and tree reduction factors. (https://github.com/gchq/coreax/issues/811)
...
### Changed
 - Metric tests now assert mathematical invariants instead of duplicating the MMD and
   KSD implementations. (https://github.com/gchq/coreax/issues/1140)
