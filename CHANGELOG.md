...
### Changed
 ...
 - Shared benchmark solver factories, cached per-dataset KDE setup and corrected
   visualiser output paths independently of the working directory. Corrected the
   blobs runner passing random seeds as failure probabilities. (https://github.com/gchq/coreax/issues/1002)
