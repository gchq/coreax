...
### Changed
 ...
 - Replaced all usage of `flax` with `equinox`, in `mnist_benchmark.py` and `score_matching.py`. Removed unused `flax` dependency.
 - Removed `networks.py` as it is no longer used.
